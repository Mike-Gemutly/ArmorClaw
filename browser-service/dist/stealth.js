...
exports.defaultStealthConfig = void 0;
exports.generateFingerprint = generateFingerprint;
exports.generateTypingDelays = generateTypingDelays;
exports.generateBezierPath = generateBezierPath;
exports.getRandomDelay = getRandomDelay;
exports.getRandomDelayFromRange = getRandomDelayFromRange;
exports.addJitter = addJitter;
//=============================================================================
// Default Stealth Configuration
//=============================================================================
exports.defaultStealthConfig = {
    fingerprint: {
 ...
 */
function generateTypingDelays(options) {
    const { text, minDelay = 50, maxDelay = 180, variance = 0.3, mistakeRate = 0.015, } = options;
    const delays = [];
    const mistakes = [];
    let totalDuration = 0;
 ...
 */
function getRandomDelayFromRange(range) {
