...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "BRIDGE_RPC_URL", "\"${project.findProperty("BRIDGE_RPC_URL") ?: "https://armorclaw.com/api"}\"")
    ...
    buildTypes {
        debug {
            ...
            // Debug defaults point to local development server (Android emulator)
            // 10.0.2.2 = host machine from emulator
            buildConfigField("String", "MATRIX_HOMESERVER", "\"http://10.0.2.2:8008\"")
            buildConfigField("String", "BRIDGE_RPC_URL", "\"http://10.0.2.2:8080/api\"")
