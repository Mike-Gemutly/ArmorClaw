...
//! and inject secrets directly into the browser without exposing them to agents.

use crate::blindfill::placeholder::{parse_placeholders, replace_placeholders, PlaceholderParseError};
...
mod tests {
    ...
    fn test_resolve_placeholders_nested_object() {
        ...
        let mut secrets = HashMap::new();
        secrets.insert("card_number".to_string(), "4242424242424242".to_string());
